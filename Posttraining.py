...
import numpy as np
from keras.layers import Dense, Activation, Conv2D, MaxPooling2D, BatchNormalization, GlobalAveragePooling2D, Reshape, Multiply
...
def basic_block(model, k):
    model1 = Conv2D(32 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model)
    model1 = BatchNormalization()(model1)
    model1 = se_block(32 * k, model1)
    model1 = Activation('relu')(model1)
    model2 = Conv2D(32 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model1)
    model2 = BatchNormalization()(model2)
    model2 = se_block(32 * k, model2)
    model2 = Activation('relu')(model2)
    model1 = keras.layers.Add()([model1, model2])
    model2 = Conv2D(32 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model1)
    ...
    model2 = Activation('relu')(model2)
    model1 = keras.layers.Add()([model1, model2])
    model3 = Conv2D(32 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model)
    model3 = BatchNormalization()(model3)
    model3 = se_block(32 * k, model3)
    model3 = Activation('relu')(model3)
    model1 = keras.layers.Concatenate()([model1, model3])
    model2 = Conv2D(32 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model1)
    ...
    model2 = Activation('relu')(model2)
    model3 = Conv2D(32 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model2)
    model3 = BatchNormalization()(model3)
    model3 = se_block(32 * k, model3)
    model3 = Activation('relu')(model3)
    model5 = keras.layers.Add()([model2, model3])
    model4 = Conv2D(32 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model1)
    model4 = BatchNormalization()(model4)
    model4 = se_block(32 * k, model4)
    model4 = Activation('relu')(model4)
    model1 = keras.layers.Concatenate()([model5, model4])
    model7 = Conv2D(64 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model)
    model7 = BatchNormalization()(model7)
    model7 = se_block(64 * k, model7)
    model7 = Activation('relu')(model7)
    model = keras.layers.Concatenate()([model1, model7])
    model = Conv2D(128 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                   kernel_regularizer=regularizers.l2(0.0001))(model)
    model = BatchNormalization()(model)
    model = se_block(128 * k, model)
    model = Activation('relu')(model)
    model1 = Conv2D(64 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model)
    model1 = BatchNormalization()(model1)
    model1 = se_block(64 * k, model1)
    model1 = Activation('relu')(model1)
    model2 = Conv2D(64 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model1)
    model2 = BatchNormalization()(model2)
    model2 = se_block(64 * k, model2)
    model2 = Activation('relu')(model2)
    model1 = keras.layers.Add()([model1, model2])
    model3 = Conv2D(64 * k, (3, 3), padding='same', kernel_initializer='he_normal',
                    kernel_regularizer=regularizers.l2(0.0001))(model)
    model3 = BatchNormalization()(model3)
    model3 = se_block(64 * k, model3)
    model3 = Activation('relu')(model3)
    model4 = keras.layers.Concatenate()([model1, model3])
    model = keras.layers.Add()([model, model4])
    model = Conv2D(128 * k, (3, 3), padding='same', kernel_initializer='he_normal',
...
plot_model(model, to_file='architecture with SE.png', show_shapes=True)
